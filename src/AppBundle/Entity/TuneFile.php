...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\TuneFileRepository")
 * @Vich\Uploadable
 */
class TuneFile
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Tune", inversedBy="tuneFiles")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\TuneFileType")
     ...
     * @return TuneFile
     */
    public function setTune(\AppBundle\Entity\Tune $tune)
    {
        $this->tune = $tune;
     ...
     * Set tuneFileType
     *
     * @param \AppBundle\Entity\TuneFileType $tuneFileType
     * @return TuneFile
     */
    public function setTuneFileType(\AppBundle\Entity\TuneFileType $tuneFileType)
    {
     ...
     * Get tuneFileType
     *
     * @return \AppBundle\Entity\TuneFileType
     */
