...
class Tune
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TuneFile", mappedBy="tune", cascade={"all"})
     */
    private $tuneFiles;
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TuneSet", mappedBy="tune1")
     */
    private $tuneSets1;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TuneSet", mappedBy="tune2")
     */
    private $tuneSets2;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TuneSet", mappedBy="tune3")
     */
    private $tuneSets3;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TuneSet", mappedBy="tune4")
     */
    private $tuneSets4;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TuneSet", mappedBy="tune5")
     */
    private $tuneSets5;
     ...
     * Add tuneFiles
     *
     * @param \AppBundle\Entity\TuneFile $tuneFile
     * @return Tune
     */
    public function addTuneFile(\AppBundle\Entity\TuneFile $tuneFile)
    {
     ...
     * Remove tuneFiles
     *
     * @param \AppBundle\Entity\TuneFile $tuneFiles
     */
    public function removeTuneFile(\AppBundle\Entity\TuneFile $tuneFiles)
    {
     ...
     * Set tuneType
     *
     * @param \AppBundle\Entity\TuneType $tuneType
     * @return Tune
     */
    public function setTuneType(\AppBundle\Entity\TuneType $tuneType)
    {
     ...
     * Get tuneType
     *
     * @return \AppBundle\Entity\TuneType
     */
