...
class TuneSet
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Tune", inversedBy="tuneSets1")
     * @ORM\JoinColumn(name="tune1_id", referencedColumnName="id", nullable=true)
     */
    private $tune1;

    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Tune", inversedBy="tuneSets2")
     * @ORM\JoinColumn(name="tune2_id", referencedColumnName="id", nullable=true)
     */
    private $tune2;

    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Tune", inversedBy="tuneSets3")
     * @ORM\JoinColumn(name="tune3_id", referencedColumnName="id", nullable=true)
     */
    private $tune3;

    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Tune", inversedBy="tuneSets4")
     * @ORM\JoinColumn(name="tune4_id", referencedColumnName="id", nullable=true)
     */
    private $tune4;

    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Tune", inversedBy="tuneSets5")
     ...
     * Set tune1
     *
     * @param \AppBundle\Entity\Tune $tune1
     * @return TuneSet
     */
    public function setTune1(\AppBundle\Entity\Tune $tune1 = null)
    {
        $this->tune1 = $tune1;
     ...
     * Set tune2
     *
     * @param \AppBundle\Entity\Tune $tune2
     * @return TuneSet
     */
    public function setTune2(\AppBundle\Entity\Tune $tune2 = null)
    {
        $this->tune2 = $tune2;
     ...
     * Set tune3
     *
     * @param \AppBundle\Entity\Tune $tune3
     * @return TuneSet
     */
    public function setTune3(\AppBundle\Entity\Tune $tune3 = null)
    {
        $this->tune3 = $tune3;
     ...
     * Set tune4
     *
     * @param \AppBundle\Entity\Tune $tune4
     * @return TuneSet
     */
    public function setTune4(\AppBundle\Entity\Tune $tune4 = null)
    {
        $this->tune4 = $tune4;
     ...
     * Set tune5
     *
     * @param \AppBundle\Entity\Tune $tune5
     * @return TuneSet
     */
    public function setTune5(\AppBundle\Entity\Tune $tune5 = null)
    {
        $this->tune5 = $tune5;
