...
/**
 * Import PDFs from mandolintab.net
 */
class ImportFromMandolinTabCommand extends ContainerAwareCommand
{
    const MANDOLINTABDOTNET_URL = 'http://www.mandolintab.net/pdf/';

    protected $output;
    protected $countOk = 0;
    protected $countKo = 0;
    protected $countNonTrouve = 0;
    protected $countTrouveX = 0;
    protected $countAbandon = 0;
